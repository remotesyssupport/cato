...
namespace Encryption
{
    public class Blowfish
    {
        ...
        #endregion member variables and enums
        ...
        #endregion Decryption functions

    }

    #region Blowfish ECB implementation
    /// <summary>  
    ...
    #region Blowfish CBC implementation
    /// <summary>
    ...
    public class BlowfishCBC : BlowfishECB
    {
        ...
        public BlowfishCBC(byte[] key) : base(key, 0, 0) { }
        ...
        /// </summary>
        /// <see cref="BlowfishECB.Initialize"/>
        public BlowfishCBC(byte[] key, int nOfs, int nLen) : base(key, nOfs, nLen) { }
